      ...
      <div className="container mx-auto px-6">
        ...
        >
            {integrations.map((integration, index) => (
              <div key={index} className="px-3">
                <div 
                  className="bg-gradient-to-br from-white to-gray-50 rounded-xl p-6 hover:shadow-xl transition-all duration-300 group border border-gray-100 hover:border-gray-200 animate-scale-in h-full"
